...
/** Timeout mode | 超时模式 */
export type TimeoutMode = "show" | "hide";
...
export interface TimeoutProps {
    ...
    children: ReactNode;
    /** Display mode: 'show' = show after delay, 'hide' = hide after delay | 显示模式：'show' = 延迟后显示，'hide' = 延迟后隐藏 */
    mode?: TimeoutMode;
...
export function Timeout({ ms, children, mode = "show", fallback = null, onTimeout }: TimeoutProps): ReactNode {
    const [ready, setReady] = useState(mode === "hide");
